...
# Benchmark REMOTE keys in SEQUENTIAL order
log "=== Benchmarking REMOTE Key Fetch Performance (SEQUENTIAL ORDER) ==="
remote_time=0
remote_fetch_times=()
...
log "Benchmarking $remote_count remote keys in sequential order..."
...
# Print final results
log "\n=== SEQUENTIAL REMOTE FETCH Benchmark Results ==="
...
log "Fetched REMOTE keys sequentially: $remote_count"
