...
# Benchmark LOCAL keys in SEQUENTIAL order
log "=== Benchmarking LOCAL Key Fetch Performance (SEQUENTIAL ORDER) ==="
local_time=0
fetch_times=()
...
log "Benchmarking $local_count local keys in sequential order..."
...
# Print final results
log "\n=== SEQUENTIAL FETCH Benchmark Results ==="
...
log "Fetched LOCAL keys sequentially: $local_count"
